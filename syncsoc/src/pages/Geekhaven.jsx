...
const HeroSection = () => {
  ...
  const societyName = 'geekhaven'; // Replace with your society name dynamically if needed
    ...
    <div className="relative bg-[#FFFDFB] min-h-screen">
      ...
      <div className="flex justify-between items-center px-6 md:px-24 py-6">
        <div className="flex items-center space-x-4">
          <div className="text-3xl font-medium text-[#683B2B]">Geekhaven</div>
        </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-8 md:px-24 min-h-[70vh] mb-16">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0">
          ...
          Technology <br/>
            <span className="text-[#D49E8D]">Solutions!</span>
          </h1>
